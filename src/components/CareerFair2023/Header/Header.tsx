    ...
    <div id={props.id} className="container-fluid m-0 bg-turq" >
        ...
        <Row xs={12} className="pl-5">
            ...
            <Col xs={3}>
              ...
              <h3 className="text-blue"> February 10th</h3>
        ...
        <Row xs={12} className="mt-n5">
          ...
          <Col xs={4}><h2 className={isMobile ? "text-blue":"text-blue font-weight-bold pt-4"}>2023 CAREER FAIR</h2></Col>
          <Col xs={1}></Col>
          <Col xs={3} className="h1 pl-4 pt-4"> <a className="text-white font-weight-bold" href="https://forms.gle/tDtGrw5dkKPNB8LG9" target="_blank" rel="noreferrer noopener"> <u>REGISTER</u> </a> </Col>
        </Row>
