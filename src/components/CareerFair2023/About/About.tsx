    ...
    <Col sm={10} xs={11} className={isMobile ? "my-3" : "my-5 py-5"}>
      ...
      <Row className={isMobile ? "" : "my-5"}>
        <Col md={4} xs={12} className={isMobile ? "my-3" : "mr-5"}>
          ...
          <p>The Girls Hoo Code Career Fair is a 4 hour Career Fair hosted by Girls Who Code at UVA that aims to help students network with companies looking for interns/part-time/full-time employees. We will have career panels and company representatives tabling for students to connect with and network.</p> 
