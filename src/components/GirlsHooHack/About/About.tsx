...
function About() {
  return (
  <Row className={`bg-hack-grey justify-content-center ${isMobile ? "" : ""} py-5`}>
    <Col sm={10} xs={11} className={`my-5 ${isMobile ? "" : "py-5"}`}>
      <h2 className="text-orange mobile-upper">About</h2>
      <Row className={`${isMobile ? "" : "my-5"}`}>
        ...
        <Col md={4} xs={12} className={`${isMobile ? "" : ""}`}>
