    ...
    <div>
      <div className="bg-peacock" style={{width:"100%"}}>
        <div className="ml-4 pt-6">
          <img src={whiteLogo} className="mb-4" width="359px" height="114px" alt="logo" style={{position:'relative', zIndex: 100, top:'370px', left:'100px'}}/>
          <Row style={{position:'relative', top:'370px', left:'115px'}}>
            <img src={email} className="mr-4" alt="logo"/>
