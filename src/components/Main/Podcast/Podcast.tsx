        ...
        <div id={props.id}>
            ...
            <Row className="justify-content-center mb-5">
                ...
                <Col lg={3} md={4} sm={5} xs={5} className="justify-content-center">
                    <Row className="justify-content-center">WHERE TO LISTEN</Row>
                    <Row className="mt-2">
                        <a href="https://podcasts.google.com/feed/aHR0cHM6Ly9hbmNob3IuZm0vcy81NjM0OTM3OC9wb2RjYXN0L3Jzcw==">
                            <img src={PodcastImage} width={isMobile ? "30px" : "75px"} alt="google podcast logo linked to gwc podcast on that platform" className="mr-2" />
                        </a>
                        <a href="https://pca.st/sv13qma1">
                            <img src={PodcastImage} width={isMobile ? "30px" : "75px"} alt="pocket cast logo linked to gwc podcast on that platform" className="mr-2" />
                        </a>
                        <a href="https://radiopublic.com/girls-hoo-code-the-podcast-WdnRkQ">
                            <img src={PodcastImage} width={isMobile ? "30px" : "75px"} alt="radiopublic logo linked to gwc podcast on that platform" className="mr-2" />
                        </a>
                        <a href="https://open.spotify.com/show/2gX38ig5BhHgdzY8NT4uZ6">
                            <img src={PodcastImage} width={isMobile ? "30px" : "75px"} alt="spotify logo linked to gwc podcast on that platform" className="mr-2" />
                        </a>
                    ...
                    <Row className="mt-2">
                        <a href="https://radiopublic.com/girls-hoo-code-the-podcast-WdnRkQ">
                            <img src={PodcastImage} width={isMobile ? "30px" : "75px"} alt="copy rss logo linked to gwc podcast on that platform" className="mr-2" />
                        </a>
                    </Row>
